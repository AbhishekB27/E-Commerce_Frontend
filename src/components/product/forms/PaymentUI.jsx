      ...
      <form onSubmit={formik.handleSubmit} className="bg-gray-100 dark:bg-gray-700 w-full">
        <div className="grid w-full min-h-[35rem] lg:grid-cols-[auto_24rem]">
          <div className="flex flex-col space-y-[0.80rem] gap-2 lg:gap-0 py-1 lg:px-5 lg:py-1">
            ...
            <div className="relative border-[2px] group w-fit  md:border-[3px] border-blue-500 dark:border-gray-300 cursor-pointer flex justify-center gap-2 items-center before:content-[''] before:absolute before:h-[95px] before:w-[60%] before:left-[-18px] hover:before:translate-x-[100%] before:transition-all overflow-hidden before:rotate-[-28deg] dark:before:bg-gray-300 before:bg-blue-500">
            <div className="flex justify-center  gap-2 relative items-end -z-0 p-1 ring-2 ring-inset ring-white dark:ring-[#121212]">
              <i className="fa-solid text-white group-hover:text-blue-500 dark:group-hover:text-gray-300 dark:text-[#121212] pl-1 fa-bag-shopping md:text-2xl hover:scale-105 transition-all"></i>
              <span className="text-sm text-white group-hover:text-blue-500 dark:group-hover:text-gray-300 dark:text-[#121212] font-medium md:text-lg tracking-wider lg:font-extrabold">
                AB
              </span>
              ...
              <div className="flex gap-1 text-white">
                {" "}
                <span className="p-1 bg-white text-gray-800 dark:text-white dark:bg-slate-900 rounded-[5px]">00</span>
                <span className="p-1 bg-white text-gray-800 dark:text-white dark:bg-slate-900 rounded-[5px]">00</span>
                <span className="p-1 bg-white text-gray-800 dark:text-white dark:bg-slate-900 rounded-[5px]">00</span>
                <span className="p-1 bg-white text-gray-800 dark:text-white dark:bg-slate-900 rounded-[5px]">00</span>{" "}
              </div>{" "}
            ...
            <div className="flex flex-col dark:bg-gray-800 px-5 py-2 justify-around lg:gap-0 gap-5 h-full">
              <div className="flex justify-between items-center">
                ...
                <div onClick={()=>{cRef.current.focus()}} className="cursor-pointer">
                  {" "}
              ...
              <div>
                <button
                  type="submit"
                  className="bg-blue-600 dark:bg-gray-300 dark:text-gray-800 font-sans font-medium active:scale-90 transition-all text-white rounded-md w-full h-full py-2 lg:py-3 font-normal lg:font-medium"
                >
                  Pay Now
                </button>
              </div>
