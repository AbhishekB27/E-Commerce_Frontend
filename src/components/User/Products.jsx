...
const Products = () => {
  return (
<div class="lg:translate-y-[-8rem] translate-y-0 pb-2 md:p-3 lg:rounded-md top-[-8rem] md:min-h-[27rem] md:shadow-xl bg-slate-100 dark:bg-gray-700 lg:translate-x-[-0.5rem] md:rounded w-full overflow-auto">
